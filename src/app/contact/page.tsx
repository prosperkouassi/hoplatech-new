      ...
      <div className="container mx-auto max-w-3xl">
        ...
        {error && (
          <div className="mb-8 p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl text-center animate-fade-in">
            <p className="text-red-700 dark:text-red-400 font-bold font-kanit">{error}</p>
          </div>
        )}

        <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-[#1a1a1a] p-6 md:p-12 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div>
              <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Prénom *</label>
              <input
                type="text"
                name="prenom"
                required
            ...
            <div>
              <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Nom *</label>
              <input
                type="text"
                name="nom"
                required
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div>
              <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Email professionnel *</label>
              <input
                type="email"
                name="email"
                required
            ...
            <div>
              <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Téléphone</label>
              <input
                type="tel"
                name="telephone"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div>
              <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Entreprise / Établissement</label>
              <input
                type="text"
                name="entreprise"
            ...
            <div>
              <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Secteur d'activité</label>
              <select
                name="secteur"
          ...
          <div>
            <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Solution qui vous intéresse</label>
            <select
              name="solution"
            ...
            >
              ...
              <option value="gestion-locative">Logiciel Gestion Locative</option>
              <option value="gestion-scolaire">Logiciel Gestion Scolaire</option>
              <option value="gestion-asso">Logiciel Gestion Association</option>
              <option value="sur-mesure">Développement Sur-mesure</option>
            </select>
          </div>

          <div>
            <label className="block text-sm font-bold mb-2 font-kanit text-brand-dark dark:text-white">Votre message</label>
            <textarea
              name="message"
              required
              rows={5}
          ...
          <button
            ...
            className={`w-full py-4 rounded-lg font-bold text-white transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg font-kanit ${
              loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-brand-primary hover:bg-red-600'
            }`}
          >
