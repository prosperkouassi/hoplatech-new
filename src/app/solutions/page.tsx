...
export const metadata: Metadata = {
  title: "Solutions SaaS en Côte d'Ivoire | Alteractweb",
  description:
    "Découvrez les solutions SaaS Alteractweb en Côte d'Ivoire : gestion locative, gestion scolaire et gestion associative, accessibles simplement en ligne.",
  ...
  openGraph: {
    title: "Solutions SaaS en Côte d'Ivoire | Alteractweb",
    description:
      "Des solutions SaaS de gestion locative, scolaire et associative conçues pour les professionnels et organisations en Côte d'Ivoire.",
    url: "/solutions",
    type: "website",
  },
};
...
export default function HomePage() {
  return (
    <main className="flex flex-col overflow-hidden bg-white text-brand-dark">
        ...
        <div className="container mx-auto px-4 pb-20 pt-24 md:pb-28 md:pt-32 lg:pb-32">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h1 className="alteract-fade-up alteract-delay-1 font-urbanist text-4xl font-bold leading-[1.05] tracking-[-0.035em] text-brand-dark sm:text-5xl md:text-6xl lg:text-7xl">
              Pilotez votre activité avec une
              <span className="alteract-shimmer mt-2 block bg-gradient-to-r from-brand-primary via-brand-secondary to-brand-primary bg-clip-text text-transparent">
                solution SaaS vraiment adaptée
              </span>
            </h1>
            ...
            <p className="alteract-fade-up alteract-delay-2 mx-auto mt-7 max-w-3xl font-kanit text-base font-light leading-7 text-gray-600 sm:text-lg md:text-xl md:leading-8">
              Alteractweb développe des solutions SaaS de gestion accessibles en ligne,
              pensées pour les professionnels de l’immobilier, les établissements scolaires
              et les associations en Côte d’Ivoire.
            </p>
      ...
      <section
        id="solutions"
        className="relative overflow-hidden bg-[#121212] py-20 text-white md:py-28"
      >
        <div
          aria-hidden="true"
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -left-40 top-20 h-[440px] w-[440px] rounded-full bg-brand-primary/20 blur-[130px]"
        />

        <div
          aria-hidden="true"
          className="pointer-events-none absolute -right-40 bottom-10 h-[500px] w-[500px] rounded-full bg-brand-secondary/15 blur-[140px]"
        />
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto mb-12 max-w-4xl text-center md:mb-16">
            ...
            <p className="mx-auto mt-5 max-w-2xl font-kanit text-base font-light leading-7 text-gray-300 md:text-lg">
              ...
              et pilotez votre organisation depuis une plateforme SaaS claire,
          ...
          <div className="relative mx-auto mb-8 max-w-7xl overflow-hidden rounded-[28px] border border-white/10 bg-[#191919] shadow-[0_40px_120px_rgba(0,0,0,0.42)]">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-4 sm:px-6">
              ...
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-primary font-urbanist text-xs font-bold text-white">
                A
              </span>
            </div>
            ...
            <div className="grid min-h-[420px] lg:grid-cols-[230px_1fr]">
              <aside className="hidden border-r border-white/10 bg-black/10 p-5 lg:block">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div
                      key={item}
                      className={`flex items-center gap-3 rounded-xl px-3 py-3 font-kanit text-xs ${
                        index === 0
              ...
              <div className="p-5 sm:p-7 lg:p-9">
                <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                  <div>
                    <p className="font-kanit text-xs uppercase tracking-[0.18em] text-brand-primary">
                      Vue d’ensemble
                    </p>

                    <h3 className="mt-2 font-urbanist text-2xl font-bold sm:text-3xl">
                      Pilotez l’essentiel en un regard
                    </h3>
                  </div>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  {[
                    ['Informations', 'Centralisées', '82%'],
                    ['Tâches', 'Automatisées', '68%'],
                    ['Pilotage', 'En temps réel', '91%'],
                    ...
                    >
                      ...
                      <p className="mt-2 font-urbanist text-lg font-bold text-white">
                        {value}
                      </p>
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-[1.35fr_.65fr]">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                    ...
                    <div className="flex h-32 items-end gap-2">
                      {[36, 52, 43, 70, 58, 84, 76, 94].map(
                        (height, index) => (
                          <span
                            key={`${height}-${index}`}
                            className="flex-1 rounded-t-md bg-gradient-to-t from-brand-primary/45 to-brand-secondary transition-opacity duration-300 hover:opacity-70"
                            style={{ height: `${height}%` }}
                          />
                        )
                      )}
                  ...
                  <div className="rounded-2xl border border-white/10 bg-brand-primary p-5">
                    <p className="font-kanit text-xs uppercase tracking-[0.16em] text-white/70">
                      Votre outil
                    </p>
                    <p className="mt-3 font-urbanist text-xl font-bold">
                      Simple au quotidien.
                    </p>
                    <p className="mt-2 font-kanit text-sm font-light leading-6 text-white/80">
                      Une interface claire, pensée pour vos équipes et vos
                      réalités métier.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
            {solutions.map((solution, index) => {
              ...
              return (
                <article
                  key={solution.slug}
                  className={`solution-card group relative overflow-hidden rounded-[26px] border border-white/10 bg-[#191919] transition-all duration-500 hover:border-brand-primary/50 ${
                    index === 0 ? 'lg:col-span-2' : ''
                  }`}
                >
                  <div
                    aria-hidden="true"
                    className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-brand-primary/0 blur-[90px] transition-colors duration-500 group-hover:bg-brand-primary/25"
                  />

                  <div
                    className={`relative z-10 grid h-full gap-8 p-6 md:p-8 ${
                      index === 0
                        ? 'lg:grid-cols-[.8fr_1.2fr] lg:p-10'
                        : ''
                    }`}
                  >
                    <div className="flex flex-col">
                      <div className="mb-7 flex items-center justify-between">
                        ...
                        <span
                          className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 font-kanit text-xs ${
                            isAvailable
                      ...
                      <h3 className="font-urbanist text-2xl font-bold tracking-tight text-white transition-colors duration-300 group-hover:text-brand-primary md:text-3xl">
                        {solution.title}
                      </h3>

                      <p className="mt-4 font-kanit text-base font-light leading-7 text-gray-400">
                        {solution.accroche}
                      </p>

                      <p className="mb-3 mt-7 font-kanit text-xs font-semibold uppercase tracking-[0.16em] text-gray-500">
                        Les difficultés résolues
                      </p>

                      <div
                        className="mb-8 flex-grow font-kanit text-sm font-light leading-6 text-gray-300 line-clamp-4 [&_p]:relative [&_p]:mb-2 [&_p]:pl-4 [&_p]:before:absolute [&_p]:before:left-0 [&_p]:before:top-[10px] [&_p]:before:h-1.5 [&_p]:before:w-1.5 [&_p]:before:rounded-full [&_p]:before:bg-brand-primary"
                        dangerouslySetInnerHTML={{
                      ...
                      <Link
                        ...
                        aria-label={`Découvrir la solution SaaS ${solution.title}`}
                        className="mt-auto inline-flex w-fit items-center rounded-xl bg-white px-5 py-3 font-kanit text-sm font-semibold text-brand-dark transition-all duration-300 hover:bg-brand-primary hover:text-white"
                      >
                    ...
                    <div
                      className={`solution-card-visual relative overflow-hidden rounded-2xl border border-white/10 bg-[#101010] p-4 ${
                        index === 0 ? '' : 'mt-1'
                      }`}
                    >
                      <div className="mb-5 flex items-center justify-between border-b border-white/10 pb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-kanit text-[11px] text-gray-400">
                            {solution.title}
                          </span>
                        </div>

                        <span className="rounded-md bg-white/[0.06] px-2 py-1 font-kanit text-[9px] text-gray-500">
                          LIVE
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {[64, 82, 48].map((value, itemIndex) => (
                          ...
                          >
                            ...
                            <div className="mt-4 font-urbanist text-lg font-bold text-white">
                              {value}%
                            </div>
                      ...
                      <div className="mt-3 rounded-xl border border-white/[0.07] bg-white/[0.04] p-4">
                        ...
                        <div className="space-y-2">
                          {[72, 88, 58].map((width, rowIndex) => (
                            <div
                              key={`${width}-${rowIndex}`}
                              className="flex items-center gap-3 rounded-lg bg-black/20 p-2.5"
                            >
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              <p className="mt-6 max-w-xl font-kanit text-base font-light leading-7 text-gray-600 md:text-lg">
                Nos solutions SaaS sont conçues à partir des besoins concrets
                des professionnels. Chaque fonctionnalité répond à une difficulté
                opérationnelle : organisation, suivi, facturation, communication
                ou pilotage.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="relative isolate mx-auto max-w-6xl overflow-hidden rounded-3xl border border-red-100 bg-gradient-to-br from-red-50 via-white to-orange-50 px-6 py-14 text-center shadow-[0_24px_80px_rgba(212,61,73,0.10)] sm:px-10 md:py-20">
            ...
            <p className="mx-auto mt-5 max-w-2xl font-kanit text-base font-light leading-7 text-gray-600 md:text-lg">
              Échangeons sur vos besoins et identifions la solution SaaS
              Alteractweb la plus adaptée à votre activité en Côte d’Ivoire.
            </p>
